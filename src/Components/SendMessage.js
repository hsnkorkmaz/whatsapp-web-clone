...
import {addMessage, getFriendById} from "./Friends"
...
const SendMessage = (props) => {
    ...
    const renderSendButton = () => {
        if (message.length > 0) {
            return (
                <div className="text-whatsApp-lightest m-2">
    ...
    return (
        <div className="bg-w-900 pb-2 pt-2 pr-3 pl-3 border-b border-w-400 flex items-center">
            <div className="text-whatsApp-lightest m-2">
                <svg viewBox="0 0 24 24" width="24" height="24">
            ...
            <div className="flex items-center space-x-4 p-3 h-10 w-full m-px bg-w-500 rounded-full text-whatsApp-lightest">

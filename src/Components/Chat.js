...
const Chat = (props) => {
    return (
        <div className="flex bg-w-900 hover:bg-w-600 cursor-pointer">
            ...
            <div className="border-b truncate ml-3 mt-2 mr-1 border-gray-500 w-full text-whatsApp-lightest">
                <div className="flex justify-between mr-2 ">
                    <div className="text-sm text-white">{props.sender}</div>
                    <div className="text-xs font-thin">{props.date}</div>
                </div>

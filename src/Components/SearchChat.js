...
const SearchChat = () => {
    return (
        <div className="bg-w-900 pb-2 pt-2 pr-3 pl-3 border-b-2 border-gray-500">
                    <div className="flex items-center space-x-4 p-3 h-7 bg-w-500 rounded-full text-whatsApp-lightest">

        ...
        <div className="w-9/12 bg-whatsApp-base flex items-center justify-center ">
            <div className="flex flex-col justify-center items-center w-8/12 text-center">
                ...
                <div className="text-gray-300 text-sm mt-5 flex items-center justify-center">
                    ...
                    <span>Make calls from desktop with WhatsApp for Windows. <a href="https://www.whatsapp.com/download" target="_blank" className="text-green-600">Get it here</a>.</span>
                </div>
            </div>
        </div>
    )
